    ...
    this.service.create(data)
      .subscribe(
        res => {
          ...
          this._snackBar.open("An error occured while creating the post", "Close", {
            duration: 5000
          })
          this.dialogRef.close()
        }
    ...
    this.service.update(this.data.id, resource)
      .subscribe(
        res => {
          ...
          this._snackBar.open("An error occured while updating the post", "Close", {
            duration: 5000
          })
          this.dialogRef.close({
            isSucces: false,
    ...
    this.service.delete(this.data.id)
      .subscribe(
        res => {
          ...
          this._snackBar.open("An error occured while deleting the post", "Close", {
            duration: 5000
          })
          this.dialogRef.close({
            isSucces: false,
